// The weather outdoors: the visitor's real weather, which the page embeds, or
// `?debug&weather=<kind>`. This file decides what the sky should hold; fx/Weather.ts draws
// it and audio/mix.ts hears it.
import { isWeatherKind, type WeatherKind, type WeatherNow } from "./weather-kinds.ts";
