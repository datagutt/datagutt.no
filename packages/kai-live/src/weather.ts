...
import { calmWeather, type WeatherKind, type WeatherNow } from "@datagutt/kai/world/weather-kinds";

export { calmWeather, isWeatherKind, WEATHER_KINDS, type WeatherKind, type WeatherNow } from "@datagutt/kai/world/weather-kinds";
