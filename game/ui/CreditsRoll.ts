// The finale's credits (docs/game/PLAN.md M5.8), rolling up the screen over the night
// scene, from content/credits.ts. Interact or a tap speeds it up for a moment, back ends
