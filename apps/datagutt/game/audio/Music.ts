// Background music (docs/game/PLAN.md B4; DESIGN §15): one looping track at a time on the
// music bus, into Phaser's output so the mute setting holds. Callers say which track should
// be playing, as often as they like (playlist.ts picks it), and a change crossfades.
//
...
// its own tail before the loop and head after it (scripts/assets/music.mjs). A decoder that
...
import type { MusicId, MusicLoop } from "../assets/manifest";
